...
// Source: github.com/ssengalanto/biscuit/pkg/interfaces (interfaces: Config)
...
func (m *MockConfig) GetTime(arg0 string) time.Time {
	m.ctrl.T.Helper()
...
func (mr *MockConfigMockRecorder) GetTime(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTime", reflect.TypeOf((*MockConfig)(nil).GetTime), arg0)
}
